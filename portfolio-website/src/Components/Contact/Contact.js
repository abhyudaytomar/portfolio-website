  ...
  return (
    <Container id="contact" ref={ref}>
      ...
      C32.666,7.326,25.339,0,16.333,0z"
            ...
            <motion.form onSubmit={handleSubmit} className="form-container" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 4, duration: 1 }}>
              <TextField
                label="Name"
                variant="outlined"
                fullWidth
      ...
      <Divider style={{ marginTop: '50px', marginBottom: '20px', backgroundColor: '#FFFFFF' }} />
